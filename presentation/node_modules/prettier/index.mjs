...
var init_production_plugins = __esm({
  "src/main/plugins/builtin-plugins/production-plugins.js"() {
    ...
    plugins = /* @__PURE__ */ toLazyLoadPlugins(
      {
        name: "acorn",
        load: () => import("prettier/plugins/acorn.mjs"),
        parsers: ["acorn", "espree"]
      },
      {
        name: "angular",
        load: () => import("prettier/plugins/angular.mjs"),
        parsers: [
          "__ng_action",
          "__ng_binding",
          "__ng_directive",
      ...
      {
        name: "babel",
        load: () => import("prettier/plugins/babel.mjs"),
        parsers: [
          "__babel_estree",
          "__js_expression",
          "__ts_expression",
      ...
      {
        name: "estree",
        load: () => import("prettier/plugins/estree.mjs"),
      ...
      {
        name: "flow",
        load: () => import("prettier/plugins/flow.mjs"),
        parsers: ["flow"]
      },
      {
        name: "glimmer",
        load: () => import("prettier/plugins/glimmer.mjs"),
      ...
      {
        name: "graphql",
        load: () => import("prettier/plugins/graphql.mjs"),
      ...
      {
        name: "html",
        load: () => import("prettier/plugins/html.mjs"),
      ...
      {
        name: "markdown",
        load: () => import("prettier/plugins/markdown.mjs"),
      ...
      {
        name: "meriyah",
        load: () => import("prettier/plugins/meriyah.mjs"),
        parsers: ["meriyah"]
      },
      {
        name: "postcss",
        load: () => import("prettier/plugins/postcss.mjs"),
      ...
      {
        name: "typescript",
        load: () => import("prettier/plugins/typescript.mjs"),
        parsers: ["typescript"]
      },
      {
        name: "yaml",
        load: () => import("prettier/plugins/yaml.mjs"),
...
async function loadYaml(file) {
  const content = await read_file_default(file);
  if (!parseYaml) {
    ({ __parsePrettierYamlConfig: parseYaml } = await import("prettier/plugins/yaml.mjs"));
  }
  try {
...
// src/main/core.js
import { builders as __doc_builders4, printer as __doc_printer } from "prettier/doc.mjs";
...
import { builders as __doc_builders3 } from "prettier/doc.mjs";
...
import { builders as __doc_builders } from "prettier/doc.mjs";
...
import { utils as __doc_utils } from "prettier/doc.mjs";
...
import { builders as __doc_builders2 } from "prettier/doc.mjs";
...
// src/index.js
import * as doc from "prettier/doc.mjs";
